...
public class Download implements Runnable {
	...
	public void run(){
		...
		try {
			...
			System.setProperty("http.agent", "Elliotcraft/1.0." + Settings.getLauncherBuild() + " Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/535.19 (KHTML, like Gecko) Chrome/18.0.1025.162 Safari/535.19");
